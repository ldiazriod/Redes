...
HD_PWD='C:/Users/mruiz/Practica1_Redes/Practica1_Redes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Emisor_Receptor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Emisor_Receptor.tcl
